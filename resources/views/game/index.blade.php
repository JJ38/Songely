...
<x-layout :links="[
    ...
    <div id="game_container" class="hidden relative flex flex-col flex-1">
        ...
        {{-- <div id="round_end_widget" class="hidden absolute flex flex-col items-center bg-white w-90 border rounded-xl z-20 right-[50%] translate-x-[50%] py-10 px-6">

            <h2 id="widget_title" class="mb-5 text-5xl font-bold">Correct!</h2>

            <p id="widget_song_score" class="text-2xl text-center">You guessed the song in 15.32s</p>

            <div class="relative border-2 border-gray-400 flex justify-between px-3 py-2 px-5 rounded-xl flex gap-2 items-center w-full mt-3 overflow-hidden">

                <img id="round_end_widget" class="absolute -z-10 right-0" src="https://i1.sndcdn.com/artworks-000153855234-iofmtj-t500x500.jpg" class="mt-5 w-max h-max overflow-hidden rounded-xl" alt="">

                <div class="flex flex-col justify-end py-1 backdrop-blur-sm">

                    <p id="widget_song_artist" class="text-xl text-white text-shadow-lg">Ariana Grande</p>
                    <p id="widget_song_title" class="text-2xl/5 font-bold text-white text-shadow-lg">Stuck With U</p>

                </div>

                <div class="p-2 bg-orange-500 rounded-full w-max h-min">
        ...
        <div id="game_end_widget" class="hidden absolute flex flex-col items-center bg-white w-150 h-150 border rounded-xl z-20 right-[50%] translate-x-[50%] py-10 px-6">
            ...
            <div class="mt-auto">
                <button id="end_game_button" class="text-white text-2xl bg-pink px-6 py-3 rounded-lg hover:bg-pink-300 hover:cursor-pointer duration-200">
                    ...
                    {{-- album cover background soundcloud button --}}
{{--
            <img class="absolute -z-10 blur-[10px]" src="https://i1.sndcdn.com/artworks-000153855234-iofmtj-t500x500.jpg" alt="">
