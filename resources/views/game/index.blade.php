...
<x-layout :links="[
    ...
    <div id="game_container" class=" relative flex flex-col flex-1">
        ...
        <div id="game_end_widget" class=" absolute flex flex-col items-center bg-white w-100 h-150 border rounded-xl z-20 right-[50%] translate-x-[50%] py-10 px-6">
            ...
            <div class="w-full flex flex-col">
                ...
                <div class="relative rounded-2xl w-full">
                    ...
                    <div id="soundcloud_card_1" class="relative border-2 border-gray-400 flex justify-between px-3 py-2 px-5 rounded-xl flex gap-2 items-center w-full mt-3 overflow-hidden">
                        ...
                        <img id="soundcloud_card_image_1" src="https://i1.sndcdn.com/artworks-0CZ4VzqvtRN6-0-t500x500.jpg" class="absolute left-0 -z-10 duration-1000"
                ...
                <div class="relative rounded-2xl w-full">
                    ...
                    <div id="soundcloud_card_2" class="relative border-2 border-gray-400 flex justify-between px-3 py-2 px-5 rounded-xl flex gap-2 items-center w-full mt-3 overflow-hidden">
                        ...
                        <img id="soundcloud_card_image_2" src="https://i1.sndcdn.com/artworks-0CZ4VzqvtRN6-0-t500x500.jpg" class="absolute left-0 -z-10 duration-1000"
                            alt="{{ Vite::asset('resources/images/album_cover_placeholder.png') }}"
                        >
                ...
                <div class="relative rounded-2xl w-full">
                    ...
                    <div id="soundcloud_card_3" class="relative border-2 border-gray-400 flex justify-between px-3 py-2 px-5 rounded-xl flex gap-2 items-center w-full mt-3 overflow-hidden">
                        ...
                        <img id="soundcloud_card_image_3" src="https://i1.sndcdn.com/artworks-0CZ4VzqvtRN6-0-t500x500.jpg" class="absolute left-0 -z-10 duration-1000"
                            alt="{{ Vite::asset('resources/images/album_cover_placeholder.png') }}"
                        >
